...
if (isset($_POST['submit'])) {
    ...
    if (!ctype_alpha($firstname)) {
        $_SESSION['add-user'] = "First Name should only contain alphabetic characters.";
    } elseif (!ctype_alpha($lastname)) {
        $_SESSION['add-user'] = "Last Name should only contain alphabetic characters.";
    } elseif (strlen($firstname) < 3 || strlen($lastname) < 3) {
        $_SESSION['add-user'] = "First Name and Last Name should be at least 3 characters long.";
    } elseif (!$username) {
