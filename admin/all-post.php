...
$query = "SELECT posts.id, posts.title, posts.category_id, categories.title as category_title FROM posts 
...
<section class="dashboard">
    ...
    <?php if (isset($_SESSION['delete-post-all'])) : ?>
        <div class="alert_message success container">
            <p><?= $_SESSION['delete-post-all'];
                unset($_SESSION['delete-post-all']);
                    ...
                    <tbody>
                        <?php while ($post = mysqli_fetch_assoc($posts)) : ?>
                            <tr>
                                ...
                                <td> <a href="<?= ROOT_URL ?>admin/all-post-delete.php?id=<?= $post['id'] ?>" class=" btn sm danger">Delete</a></td>
                            </tr>
                        <?php endwhile ?>
                    </tbody>
                </table>
